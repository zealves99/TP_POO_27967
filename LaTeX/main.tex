...
\title{	
	\normalfont\normalsize
	\textsc{Escola Superior de Tecnologia}\\ % Your university, school and/or department name(s)
	\vspace{5pt} % Whitespace
	\textsc{Instituto Politécnico do Cávado e do Ave}\\
...
\author{\LARGE José António da Cunha Alves} % Your name
